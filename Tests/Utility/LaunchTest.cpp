...
#include <Utility/Launch/EntryPoint.hpp>
...
protected:
    ...
    void onTick() override { drawFrame(); }

    void onShutdown() override { cleanup(); }

    void onResize(u32 width, u32 height) override { framebufferResized = true; }
