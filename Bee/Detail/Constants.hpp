...
#define DEFINE_CONSTANT_FUNC(name, val)                                                                                \
    template<FloatType F = Float>                                                                                      \
    BEE_FUNC constexpr F name() noexcept                                                                               \
    {                                                                                                                  \
...
BEE_FUNC constexpr T Epsilon()
{
    return std::numeric_limits<T>::epsilon();
}

template<FloatType T>
BEE_FUNC constexpr T Infinity()
{
    return std::numeric_limits<T>::infinity();
}

template<ArithmeticType T>
BEE_FUNC constexpr T Zero()
{
    return T(0);
}

template<ArithmeticType T>
BEE_FUNC constexpr T One()
{
    return T(1);
}

template<ArithmeticType T>
BEE_FUNC constexpr T Two()
{
    return T(2);
}

template<i32 N>
BEE_FUNC constexpr auto Pow(std::floating_point auto v)
{
    if constexpr (N == 0)
        return 1;
...
BEE_FUNC constexpr auto Pow2(std::floating_point auto v)
{
    return Pow<2>(v);
}
